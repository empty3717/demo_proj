...
import com.empty.refreshlib.library.ILoadingLayout;
	...
	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
		...
		switch (mode) {
			case PULL_FROM_END:
				...
				LayoutParams lp1 = (LayoutParams) mInnerLayout.getLayoutParams();
			...
			default:
				LayoutInflater.from(context).inflate(R.layout.pull_to_refresh_header_vertical, this);
				mInnerLayout = (RelativeLayout) findViewById(R.id.fl_inner);
				LayoutParams lp2 = (LayoutParams) mInnerLayout.getLayoutParams();
				mHeaderText = (TextView) mInnerLayout.findViewById(R.id.pull_to_refresh_text);
				mHeaderProgress = (ProgressWheel) mInnerLayout.findViewById(R.id.pull_to_refresh_progress);
				mSubHeaderText = (TextView) mInnerLayout.findViewById(R.id.pull_to_refresh_sub_text);
				mHeaderImage = (ImageView) mInnerLayout.findViewById(R.id.pull_to_refresh_image);
