...
public class SwipeMenuLayout extends FrameLayout {
	...
	private void init() {
		...
		// mScroller = ScrollerCompat.create(getContext(), new BounceInterpolator());
	...
	/**
	 * set mContentView and mMenuView layout
	 *
	 * */
	...
	public void smoothOpenMenu() {
		...
		Log.i( "##smoothOpenMenu", "##"+(-mContentView.getLeft()));

		mOpenScroller.startScroll(-mContentView.getLeft(), 0,
				mMenuView.getWidth(), 0, 350);//dx为正数向屏幕左边滚动
		postInvalidate();
	}
