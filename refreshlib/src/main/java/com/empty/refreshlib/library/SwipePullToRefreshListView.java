...
import com.empty.refreshlib.library.internal.EmptyViewMethodAccessor;
import com.empty.refreshlib.library.internal.LoadingLayout;
import com.empty.refreshlib.library.swipemenulistview.SwipeMenuCreator;
import com.empty.refreshlib.library.swipemenulistview.SwipeMenuListView;

public class SwipePullToRefreshListView extends PullToRefreshAdapterViewBase<SwipeMenuListView > {
	...
	public SwipePullToRefreshListView(Context context, Mode mode) {
		super(context, mode);
	}

	public SwipePullToRefreshListView(Context context, Mode mode, AnimationStyle style) {
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
			...
			OverscrollHelper.overScrollBy(SwipePullToRefreshListView.this, deltaX, scrollX, deltaY, scrollY, isTouchEvent);
	...
	protected class InternalListView extends SwipeMenuListView implements EmptyViewMethodAccessor {
		...
		public void setEmptyView(View emptyView) {
			SwipePullToRefreshListView.this.setEmptyView(emptyView);
		}
